class MantenimientoPredioService {
  constructor() {
    ...
    this.grupoTierras = [
      ...
      { value: "FORESTALES", label: "Forestales" },
      { value: "PECUARIOS", label: "Pecuarios" },
      { value: "AGROFORESTALES", label: "Agroforestales"}
    ]

    this.rangoAltitud = [
      { value: "0-1000", label: "0 - 1000 msnm" },
      { value: "1000-2500", label: "1000 - 2500 msnm" },
      { value: "2500-3500", label: "2500 - 3500 msnm" },
      { value: "3500-4000", label: "3500 - 4000 msnm" }
    ]

    this.calidadAgricola = [
