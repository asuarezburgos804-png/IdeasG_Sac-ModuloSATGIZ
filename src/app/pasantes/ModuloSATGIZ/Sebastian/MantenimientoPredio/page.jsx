...
import FormularioPredioRural from "@/components/Sebastian/MantenimientoPredio/FormularioPredioRural";
...
function FormularioRegistroPredio({ tipoPredio, onRegistrar, onVolver, cargando }) {
  const [formData, setFormData] = useState({
    ...
    // Nuevos campos para predio rural
    // Ubicación
    departamento: "",
    provincia: "",
    distrito: "",
    ...
    <>
      ...
      <form onSubmit={handleSubmit}>
        ...
        {tipoPredio === "RURAL" ? (
          ...
          // Para predio urbano, mantener el formulario básico
